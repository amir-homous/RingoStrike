<template>
  <div class="stack-8">
    ...
    <div class="track" role="progressbar" :aria-valuenow="safePercent" aria-valuemin="0" aria-valuemax="100">
...
.fill{
  ...
  background: linear-gradient(90deg, rgba(99,102,241,0.88), rgba(56,189,248,0.88));
